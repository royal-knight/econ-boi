...
module.exports.run = async (bot, message, args) => {
    ...
    .setDescription(`**Input a Leaderboard Option**\n\nCoin Leaderboard: k?leaderboard coins\nFresh Nikes Leaderboard: k?leaderboard nikes\nCar Leaderboard: k?leaderboard car\nMansion Leaderboard: k?leaderboard mansion`)
    .setColor("#FFFFFF")
